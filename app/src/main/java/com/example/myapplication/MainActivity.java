...
public class MainActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        visionBuilder.setVisionRequestInitializer(new VisionRequestInitializer("AIzaSyD0ONVovLBMhzWI2nU0XEkJguQO-y_cJrI"));
    ...
    public void ProcesarFace(View View) {
        AsyncTask.execute(new Runnable() {
            @Override
            public void run() {
                ...
                try {
                    ...
                    paint.setColor(Color.BLUE);  paint.setStrokeWidth(30);
